...
const doctorFormSchema = z.object({
  ...
  experience: z
    ...
    .min(1, "Minimum experience needed is 1 year")
  ...
  description: z
    ...
    .max(1000, "Word limit of 1000 exceeded"),
});
            ...
            <form  onSubmit={handleSubmit(onDoctorSubmit)} className="space-y-6">
                <div className="space-y-2">
                 ...
                 <div className="space-y-2">
                    ...
                    <Input id="credentialUrl" type="url" placeholder="https://github.com/piyush-eon/doctors-appointment-platform"
