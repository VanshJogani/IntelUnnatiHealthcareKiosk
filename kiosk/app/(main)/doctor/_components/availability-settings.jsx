...
export function AvailabilitySettings({ slots }) {
  ...
  const onSubmit = async (data) => {
    ...
    // Create date objects
    const startDate = createLocalDateTime(data.date, data.startTime);
const endDate = createLocalDateTime(data.date, data.endTime);
...
<p className="text-xs text-muted-foreground">
  {format(new Date(slot.date), "do MMM yyyy")} • {slot.appointment ? "Booked" : "Available"}
</p>
