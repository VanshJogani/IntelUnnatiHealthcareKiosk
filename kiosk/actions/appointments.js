...
export async function getAvailableTimeSlots(doctorId) {
  try {
    ...
    // Fetch all availabilities for the doctor within the next 4 days
    ...
    for (const day of days) {
      ...
      // Find availability for this day (match by date)
    const dayAvailabilities = availabilities.filter((a) => {
        return format(new Date(a.startTime), "yyyy-MM-dd") === dayString;
      });
      ...
      // For each availability block of the day, generate 30-min slots
